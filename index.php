...
var_dump($ind);
echo "<br><br>";
$ut_r = new EUtente_Registrato("Mario", "Rossi", "+39 328 123456", new DateTime("2004-08-16"),array(),array($ind),array(),"rossi@mar.io");
var_dump($ut_r);
echo "<br><br>";
$ges = new EGestore_Magazzino("Mario", "Rossi", "+39 328 123456", new DateTime("2004-08-16"));
var_dump($ges);
echo "<br><br>";
