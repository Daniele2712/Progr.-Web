...
class M_Indirizzo extends Model{
    ...
    public function __construct(int $id, M_Comune $comune=null, string $via="", int $civico=0, string $note="", float $lat=NULL, float $lng=NULL){
        $this->id = $id;
        if($comune === null)
            $this->comune = new M_Comune();
        else
    ...
    public function getComune():\Models\M_Comune{
    ...
    public function distance(M_Indirizzo $addr): float{
