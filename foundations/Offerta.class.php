...
abstract class Offerta extends Foundation{

    public static function find(int $id): \Models\Offerta{
        $DB = \Singleton::DB();
    ...
    public static function create($obj): \Models\Offerta{
        $Fname = "Foundations\\Offerta".$obj["tipo"];
