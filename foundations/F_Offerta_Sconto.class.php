...
class F_Offerta_Sconto extends F_Offerta{
    protected static $table = "offerte_sconti";

    protected static function load(int $idOfferta, string $tipo, \DateTime $inizio, \DateTime $fine): \Models\M_OffertaSconto{
        ...
        elseif($f === NULL)
            ...
            return new \Models\M_OffertaSconto($id, $tipo, $inizio, $fine, $id, $idProdotto, $prezzo, $valuta);
    }
