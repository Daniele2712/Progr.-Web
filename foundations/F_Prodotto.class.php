...
public static function create(array $obj): Model{
    ...
    return new \Models\M_Prodotto($obj["id"], $obj["nome"],$obj["info"],$obj["descrizione"], F_Categoria::find($obj["id_categoria"]), new \Models\M_Money($obj["prezzo"], $obj["id_valuta"]), $r);
}
...
public static function insert(Model $prodotto, array $params = array()): int{
  ...
  $DB = \Singleton::DB();
  $sql = "INSERT INTO prodotti VALUES(NULL, ?, ?, ?, ? ,? ,?)";
  $p = $DB->prepare($sql);
  $money=$prodotto->getPrezzo();
  $categoriaid=$prodotto->getCategoriaId();
