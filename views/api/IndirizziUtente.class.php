...
class IndirizziUtente extends JSONView{
    ...
    public function setIndirizzoPreferito(\Models\Indirizzo $preferito){
        $this->data["preferito"] = $this->addr($preferito);
    }

    private function addr(\Models\Indirizzo $addr):array{
        $c = $addr->getComune();
        return array(
            "id"=>$addr->getId(),
            "comune"=>$c->getNome(),
